          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-header" style="padding: 15px; display: flex; justify-content: center; align-items: center;">
                <h1 class="modal-title fs-5" id="staticBackdropLabel" style="font-weight: bold; text-align: center; margin: 0;">Tambah Tahun Ajaran</h1>
              ...
              <div class="modal-body" style="padding: 20px;">
                <!-- Form Tambah Kasir -->
                <form id="tambahKasirForm" action="{{route('tahun_ajaran.store')}}" method="POST">
                  @csrf
                  <div class="mb-3">
                    <div class="mb-3">
                      <label for="tahun_ajaran" class="form-label" style="font-weight: bold;">Tahun Ajaran</label>
                      <input type="text" class="form-control"  id="tahun_ajaran" name="tahun_ajaran" placeholder="Tahun Ajaran" required style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                    </div>
                    <label for="status" class="form-label" style="font-weight: bold;">Status</label>
                    <input type="text" class="form-control" id="status" name="status" placeholder="Masukan Status" required style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                  </div>
                </form>
              </div>
              <!-- Modal Footer -->
        ...
        <div class="modal fade" id="staticBackdropUpdate" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <!-- Modal Header -->
              <div class="modal-header" style="padding: 15px; display: flex; justify-content: center; align-items: center;">
                <h1 class="modal-title fs-5" id="staticBackdropLabel" style="font-weight: bold; text-align: center; margin: 0;">Edit Tahun Ajaran</h1>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" style="background-color: white; opacity: 1; border-radius: 50%;"></button>
              </div>
              <!-- Modal Body -->
              <div class="modal-body" style="padding: 20px;">
                ...
                @csrf
                  ...
                  <div class="mb-3">
                    <div class="mb-3">
                      <label for="tahun_ajaran2" class="form-label" style="font-weight: bold;">Tahun Ajaran</label>
                      <input type="text" class="form-control"  id="tahun_ajaran2" name="tahun_ajaran2" placeholder="Tahun Ajaran" required style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                    </div>
                    <label for="status2" class="form-label" style="font-weight: bold;">Status</label>
                    <input type="text" class="form-control" id="status2" name="status2" placeholder="Masukan status" required style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                  </div>
                </form>
              </div>
              <!-- Modal Footer -->
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="staticBackdropLabel">Hapus Tahun Ajaranr</h1>
            ...
            <tr class="align-middle">
                ...
                style="width: 100px; height: auto; border-radius: 8px; object-fit: cover;"></td> -->
                    ...
                    <a 
                      ...
                      onclick="setEditData('{{ $data->id }}', '{{ $data->tahun_ajaran }}', '{{ $data->status }}')" 
                      class="text-warning" 
                      title="Edit">
...
<script>
    ...
    function setEditData(id, tahun_ajaran, status) {
        // Isi nilai form
        document.getElementById('id').value = id;
        document.getElementById('tahun_ajaran2').value = tahun_ajaran;
        ...
        const baseUrl = "{{ url('/tahun_ajaran/update-tahun_ajaran/') }}/"; // URL dasar tanpa parameter
    ...
    function setDeleteData(id) {
        ...
        const baseUrl = "{{ url('/tahun_ajaran/hapus/') }}/"; // URL dasar tanpa parameter
        form.action = `${baseUrl}${id}`;
    }
