          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-header" style="padding: 15px; display: flex; justify-content: center; align-items: center;">
                <h1 class="modal-title fs-5" id="staticBackdropLabel" style="font-weight: bold; text-align: center; margin: 0;">Tambah kriteria Penilaian</h1>
              ...
              <div class="modal-body" style="padding: 20px;">
                <!-- Form Tambah Kasir -->
                <form id="tambahKasirForm" action="{{route('kriteria.store')}}" method="POST">
                  @csrf
                  <div class="mb-3">
                    <div class="mb-3">
                      <label for="nama_kriteria" class="form-label" style="font-weight: bold;">Nama Kriteria</label>
                      <input type="text" class="form-control"  id="nama_kriteria" name="nama_kriteria" placeholder="Nama Kriteria" required style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                    </div>
                    <label for="bobot" class="form-label" style="font-weight: bold;">Bobot</label>
                    <input type="text" class="form-control" id="bobot" name="bobot" placeholder="Masukan Bobot" required style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                  </div>
                </form>
              </div>
              <!-- Modal Footer -->
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="padding: 20px;">
                ...
                @csrf
                  ...
                  <div class="mb-3">
                    <div class="mb-3">
                      <label for="nama_kriteria2" class="form-label" style="font-weight: bold;">Nama Kriteria</label>
                      <input type="text" class="form-control"  id="nama_kriteria2" name="nama_kriteria2" placeholder="Nama Kriteria" required style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                    </div>
                    <label for="bobot2" class="form-label" style="font-weight: bold;">Bobot</label>
                    <input type="text" class="form-control" id="bobot2" name="bobot2" placeholder="Masukan Bobot" required style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                  </div>
                </form>
              </div>
              <!-- Modal Footer -->
            ...
            <tr class="align-middle">
                ...
                style="width: 100px; height: auto; border-radius: 8px; object-fit: cover;"></td> -->
                    ...
                    <a 
                      ...
                      onclick="setEditData('{{ $data->id }}', '{{ $data->nama_kriteria }}', '{{ $data->bobot }}')" 
                      class="text-warning" 
                      title="Edit">
...
<script>
    ...
    function setEditData(id, nama_kriteria, bobot) {
        // Isi nilai form
        document.getElementById('id').value = id;
        document.getElementById('nama_kriteria2').value = nama_kriteria;
        document.getElementById('bobot2').value = bobot;

        // Perbarui action form dengan id_member
        const form = document.getElementById('updateKasirForm');
        const baseUrl = "{{ url('/kriteria/update-kriteria/') }}/"; // URL dasar tanpa parameter
    ...
    function setDeleteData(id) {
        ...
        const baseUrl = "{{ url('/kriteria/hapus/') }}/"; // URL dasar tanpa parameter
        form.action = `${baseUrl}${id}`;
    }
