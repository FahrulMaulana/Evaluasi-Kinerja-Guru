          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-header" style="padding: 15px; display: flex; justify-content: center; align-items: center;">
                <h1 class="modal-title fs-5" id="staticBackdropLabel" style="font-weight: bold; text-align: center; margin: 0;">Tambah Kompetensi</h1>
              ...
              <div class="modal-body" style="padding: 20px;">
                <!-- Form Tambah Kasir -->
                <form id="tambahKasirForm" action="{{route('kompetensi.store')}}" method="POST">
                  @csrf
                  <div class="mb-3">
                    <div class="mb-3">
                      <label for="nama_kompetensi" class="form-label" style="font-weight: bold;">Nama Kompetensi</label>
                      <input type="text" class="form-control"  id="nama_kompetensi" name="nama_kompetensi" placeholder="Nama Kompetensi" required style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                      </div>
                    </div>
                </form>
              </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body" style="padding: 20px;">
                ...
                @csrf
                  ...
                  <div class="mb-3">
                    <div class="mb-3">
                      <label for="nama_kompetensi2" class="form-label" style="font-weight: bold;">Nama Kompetensi</label>
                      <input type="text" class="form-control"  id="nama_kompetensi2" name="nama_kompetensi2" placeholder="Nama Kompetensi" required style="padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                    </div>
                  </div>
                </form>
              </div>
            ...
            <tr class="align-middle">
                ...
                <td>{{ $data->nama_kompetensi }}</td>
                    ...
                    <a 
                      ...
                      onclick="setEditData('{{ $data->id }}', '{{ $data->nama_kompetensi }}')" 
                      class="text-warning" 
                      title="Edit">
...
<script>
    ...
    function setEditData(id, nama_kompetensi) {
        // Isi nilai form
        document.getElementById('id').value = id;
        document.getElementById('nama_kompetensi2').value = nama_kompetensi;

        // Perbarui action form dengan id_member
        const form = document.getElementById('updateKasirForm');
        const baseUrl = "{{ url('/kompetensi/update-kompetensi/') }}/"; // URL dasar tanpa parameter
    ...
    function setDeleteData(id) {
        ...
        const baseUrl = "{{ url('/kompetensi/hapus/') }}/"; // URL dasar tanpa parameter
        form.action = `${baseUrl}${id}`;
    }
